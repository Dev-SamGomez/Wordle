                ...
                <div className="rounded-2xl border border-[#3a3a3c] bg-[#1a1a1b] p-6 shadow-xl shadow-black/30">
                    ...
                    <div className="mb-5 flex gap-1 rounded-xl bg-[#2a2a2c] p-1">
                        <button
                            ...
                            className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition-all ${activeTab === "create"
                        ...
                        <button
                            ...
                            className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition-all ${activeTab === "join"
                                ? "bg-[#538d4e] text-white shadow-sm"
                                : "text-[#818184] hover:text-[#e5e5e7]"
                                }`}
                        >
                    ...
                    {activeTab === "create" ? (
                        <div className="space-y-4">
                            <p className="text-sm text-[#818184]">
                                Crea una nueva sala y comparte el codigo con tu rival para
                                empezar la partida.
                            </p>
                            <button
