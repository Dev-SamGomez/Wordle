                            ...
                            return (
                                ...
                                >
                                    ...
                                    {item.action === "word-of-day" && (
                                        <span className="inline-flex items-center gap-1 rounded-full border border-[#3a3a3c] bg-[#2a2a2c] px-2 py-0.5">
                            ...
                            <div key={item.label} className="px-3">
                                <Accordion type="single" collapsible>
                                    <AccordionItem value={item.label} className="border-b-0">
                                        <AccordionTrigger className="px-2 py-3.5 text-[#d7dadc] hover:no-underline hover:bg-[#3a3a3c]/50 rounded-md transition-colors">
                                            <span className="text-sm font-medium">{item.label}</span>
                                        </AccordionTrigger>
